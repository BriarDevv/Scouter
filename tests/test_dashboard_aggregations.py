...
def test_dashboard_pipeline_breakdown_returns_stages(db):
    from app.services.dashboard.dashboard_service import get_pipeline_breakdown
...
def test_dashboard_time_series_returns_correct_days(db):
    from app.services.dashboard.dashboard_service import get_time_series
...
def test_dashboard_industry_breakdown_empty(db):
    from app.services.dashboard.dashboard_service import get_industry_breakdown
...
def test_dashboard_city_breakdown_empty(db):
    from app.services.dashboard.dashboard_service import get_city_breakdown

...
_ALLOWED_SETTINGS_FIELDS = {
    ...
    "mail_from_name",
    "mail_reply_to",
    "mail_send_timeout_seconds",
    "require_approved_drafts",
    "mail_inbound_sync_enabled",
    "mail_inbound_mailbox",
    "mail_inbound_sync_limit",
    "mail_inbound_timeout_seconds",
    "mail_inbound_search_criteria",
...
def get_effective_mail_inbound(row: OperationalSettings) -> dict:
    return {
        ...
        "use_reviewer_for_labels": row.use_reviewer_for_labels
        or list(env.mail_use_reviewer_for_labels),
    }

...
export function SaveButton({
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 rounded-xl bg-foreground px-4 py-2 text-sm font-medium text-background transition hover:bg-foreground/80 disabled:opacity-50"
    >
      {saving ? (

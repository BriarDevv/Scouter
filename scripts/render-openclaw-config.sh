...
CLAWSCOUT_API_BASE_URL_RENDERED="${OPENCLAW_CLAWSCOUT_API_BASE_URL:-${CLAWSCOUT_API_BASE_URL:-http://127.0.0.1:8000/api/v1}}"
...
export CLAWSCOUT_API_BASE_URL_RENDERED
...
placeholders = {
    ...
    "__CLAWSCOUT_API_BASE_URL__": os.environ["CLAWSCOUT_API_BASE_URL_RENDERED"],
...
log "ClawScout API base URL for skills: $CLAWSCOUT_API_BASE_URL_RENDERED"
